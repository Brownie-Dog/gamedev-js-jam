...
namespace ItemDrops
{
    [CreateAssetMenu(fileName = nameof(WeaponItemData), menuName = "ScriptableObjects/Items/Weapon")]
    public class WeaponItemData : ItemData
    {
        [field: SerializeField] public GameObject WeaponPrefab { get; private set; } = null;

        [field: SerializeField] public int Damage { get; private set; } = 1;

        [field: SerializeField] public float CooldownTime { get; private set; } = 0f;

        [field: SerializeField] public AimMode DefaultAimMode { get; private set; } = AimMode.None;

        [field: SerializeField] public bool AutoFire { get; private set; } = false;
